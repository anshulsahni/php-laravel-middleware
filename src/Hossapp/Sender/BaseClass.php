...
class BaseClass {
    ...
    private $_defaults = array(
        "max_batch_size"    => 10, // the max data size hossapp will accept is 250k.
        "max_queue_size"    => 10, // the max num of items to hold in memory before flushing
        "debug"             => true, // enable/disable debug mode
        "consumer"          => "curl", // which consumer to use
        "host"              => "ingress.hoss.com", // the host name for api calls
        "use_ssl"           => true, // use ssl when available
        "error_callback"    => null // callback to use on consumption failures
    );
    /**
     * An array of options to be used by the hossapp library.
     * @var array
     */
