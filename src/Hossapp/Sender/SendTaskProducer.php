...
if (!function_exists('json_encode')) {
    throw new Exception('The PHP JSON extension is required');
}
/**
...
class SendTaskProducer extends BaseClass {
    /**
     * @var string a token associated to a Hossapp project
     */
    protected $_appId;
    /**
    ...
    /**
     * Creates a new Send Task Producer, assings Hossapp project applicadation Id.
     * @param $token
     * @param array $options
     */
    ...
    /**
     * Returns the current Hossapp project token
     * @return string
     */
    ...
    /**
     * Add an array representing a message to be sent to Hossapp to a queue.
     * @param array $message
     */
